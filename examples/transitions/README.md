# Free terrain-transition TileSets — grass/sand, sand/water shoreline, stone/grass path, water/grass pond, grass/stone overgrown floor — Godot 4
...
seam between them. Five pairs, each in 16px and 32px.
...
ten PNGs and, for each TileSet, paints a 14×11 field of the under terrain with a
...
2026-09-14 (16/16); all five pairs on 2026-09-15, **80/80 checks on each of
...
T6 was also run inverted (`LG_SELFTEST=1`): exit 1 with exactly the ten T6
...
Blobsmith build repo from the same base blocks as the starter pack.
